import{b as w}from"./sessionService-CNTaYAsY.js";const b=document.getElementById("summaryStats"),u=document.getElementById("histogramContainer"),f=document.getElementById("intervalContainer"),p=document.getElementById("tabRoot");let i=null,o="all";function $(e){var t;return((t=i==null?void 0:i.scenarios[e])==null?void 0:t.label)??(e==="disaster"?"Disaster relief":e==="chore"?"Household chores":String(e))}function v(e){p.innerHTML="",[{value:"all",label:"All"}].concat(e.map(n=>({value:n,label:$(n)}))).forEach(n=>{const s=document.createElement("button");s.type="button",s.dataset.filter=n.value,s.textContent=n.label,s.classList.toggle("active",o===n.value),s.addEventListener("click",()=>{o=n.value,v(e),y()}),p.appendChild(s)})}function g(){return i?o==="all"?i.completed_sessions:i.completed_sessions.filter(e=>e.scenario===o):[]}function L(){const e=g(),t=e.map(s=>s.query_count),n=t.length?(t.reduce((s,a)=>s+a,0)/t.length).toFixed(2):"0.00";b.innerHTML=`
